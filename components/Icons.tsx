...
export const LogoIcon = ({ className }: { className?: string }) => (
    ...
    >
        <path d="M14.5 17.5C12.3 19.8 8.8 20.2 6.5 18.5C4.2 16.8 3.8 13.3 5.5 11C7.2 8.7 10.7 8.2 13.5 9.5" />
        <path d="M12 12L15 6L18 9L21 3" />
        <path d="M18 9C19.1 9 20 8.1 20 7C20 5.9 19.1 5 18 5C16.9 5 16 5.9 16 7C16 8.1 16.9 9 18 9Z" />
    </svg>
);